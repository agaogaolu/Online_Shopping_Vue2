        ...
        <div class="comment">
            ...
            <div class="comment-list">
                <div class="comment-item" v-for="item in commentList" :key="item.comment_id">
                    <div class="top">
                        <img :src="item.avatar_url || defuaultImg" alt="">
...
import defuaultImg from '@/assets/default-avatar.png'
...
export default {
    ...
    methods: {
        ...
        async getComments() {
            ...
            let res = await getProComments(this.goodsId, 3)
            console.log(res)
        ...
        async addCart() {
            console.log(this.$store.getters.token == false)
