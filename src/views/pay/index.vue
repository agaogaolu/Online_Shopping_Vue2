<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="selectdAddress.address_id">
        <div class="info-content">
          <span class="name">{{ selectdAddress.name }}</span>
          <span class="mobile">{{ selectdAddress.phone }}</span>
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!selectdAddress">请先选择配送地址</span>
...
export default {
  ...
  computed: {
    ...
    longAddress() {
      const region = this.selectdAddress.region
      return region.province + region.city + this.selectdAddress.detail
    },
    mode() {
